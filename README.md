...
<img width="1754" height="940" alt="DD Platform Main Interface" src="https://github.com/user-attachments/assets/5c1d2ca1-43a9-4b2f-aea0-341cf5fd690f" />
...
|-----------------|--------------|
| **架构 / Architecture** | Microservices, Event-Driven, Single Responsibility, API-First Design, Layered Building |
...
| `update_agent` | 修改 Agent 属性 / Modify agent |
